...
func setCORSHeaders(w http.ResponseWriter, origin string, allowAll bool) {
	...
	w.Header().Set("Access-Control-Allow-Headers", "Authorization, MM-Authorization, Content-Type, X-Session-Id")
	w.Header().Set("Access-Control-Expose-Headers", "X-Silent-Mode, X-Encrypted, X-Session-Id")
}
